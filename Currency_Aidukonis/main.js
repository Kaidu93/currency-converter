...
// Tikrinam ar ivestas value yra skaicius, o jeigu nulis tai naudojam placeholderi
...
function populateAddCurrencyList() {
    for (let i = 0; i < currencies.length; i++) {
        // insertAjacentHTML geriau nei innerHTML nes necorruptina esamu elementu ir greiciau uzkrauna
